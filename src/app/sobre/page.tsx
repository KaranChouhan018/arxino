            ...
            <div className="wp-block-columns alignwide is-layout-flex wp-container-core-columns-is-layout-1 wp-block-columns-is-layout-flex">
              ...
              >
                ...
                >
                  ...
                  ></span>
                  <Image
                    src="https://images.unsplash.com/photo-1606185540834-d6e7483ee1a4?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt=""
                    width={2560}
                    height={1920}
                    ...
                    <div className="wp-block-cover__inner-container has-global-padding is-layout-constrained wp-container-core-cover-is-layout-3 wp-block-cover-is-layout-constrained">
                      <div className="wp-block-group is-nowrap is-layout-flex wp-container-core-group-is-layout-11 wp-block-group-is-layout-flex">
                        <figure className="wp-block-image size-large is-resized ext-aspect-landscape wp-duotone-df620e-ccc-2">
                          <img
                            decoding="async"
                            src="data:image/svg+xml;base64,"
                            alt=""
                            style={{
                              objectFit: "cover",
                              width: 57,
                ...
                <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                  ...
                  >
                    ...
                    <p
                      ...
                      style={{ marginTop: 12 }}
                    >
                      Nuestros valores se centran en ofrecer un servicio de alta{" "}
                      <strong>calidad</strong>y operar bajo estrictos estándares
                      de seguridad. Apostamos por la
                      <strong>innovación</strong> y la{" "}
                      <strong>sostenibilidad</strong>, mejorando constantemente
                      nuestros procesos para un desarrollo energético
                      responsable. Además, fomentamos la{" "}
                      <strong>colaboración </strong>
                      estratégica a través de alianzas que generan valor y
